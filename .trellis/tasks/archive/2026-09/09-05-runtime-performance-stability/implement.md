...
- [ ] 正式发布候选版按 [`release-performance-validation.md`](release-performance-validation.md) 对比优化前后高/中/低三档真机指标；当前无对应真机，本阶段不阻塞。
...
- [ ] 正式发布候选版按 [`release-performance-validation.md`](release-performance-validation.md) 完成前台连续演奏 20 分钟及高/中/低真机矩阵；当前无对应真机，本阶段不阻塞。
