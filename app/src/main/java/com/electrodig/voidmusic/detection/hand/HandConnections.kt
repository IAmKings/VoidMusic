...
/**
 * Pairs of landmark indices that form the hand skeleton edges (MediaPipe Hands
 * topology). Used by the viewfinder overlay to draw the bone connections.
 */
object HandConnections {
    val EDGES: List<Pair<Int, Int>> = listOf(
        ...
        // Palm
        0 to 5, 5 to 9, 9 to 13, 13 to 17
    )
}
